...
Após fazer o DAG, conseguimos concluir que podemos paralelizar o laço que realiza as sucessivas somas de 1/fatorial(i). Assim, dividimos, inicialmente, igualmente as iterações para as duas threads.   
...
Após ficar instagnado em 18 casas, devido chegar ao máximo do tipo da linguagem, vimos a necessidade de buscar uma solução que solucionasse o problema, a biblioteca GMP, que consegue tratar os números em quantidades exorbitantes.
